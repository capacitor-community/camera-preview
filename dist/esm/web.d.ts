...
export declare class CameraPreviewWeb extends WebPlugin implements CameraPreviewPlugin {
  ...
  setFlashMode(_options: { flashMode: CameraPreviewFlashMode | string }): Promise<void>;
  flip(): Promise<void>;
  getZoom(): Promise<{
    value: number;
  }>;
  setZoom(_options: { zoom: number }): Promise<void>;
  getMaxZoom(): Promise<{
    value: number;
  }>;
  ...
  setMaxZoomLimit(_options: { zoom: number }): Promise<void>;
